OC.L10N.register(
    ...
    "Embed an installation of Roundcube into Nextcloud" : "Vložte inštaláciu Roundcube do Nextcloudu",
    "Integrates an existing Roundcube standalone email-webapp into Nextcloud, with optional SSO." : "Integruje existujúcu samostatnú webovú aplikáciu Roundcube do Nextcloudu, s voliteľným SSO.",
    ...
    "You did not tell me where to find your configured Roundcube\ninstance. Please head over to the admin-settings and configure this\napp, thank you! It might also be a good idea to have a look at the\nREADME.md file which is distributed together with this app." : "Nezadal(a) si, kde nájsť tvoju nakonfigurovanú inštanciu Roundcube. Prosím, prejdite do administrátorských nastavení a nakonfigurujte túto aplikáciu, ďakujem! Môže byť tiež dobrý nápad pozrieť sa na súbor README.md, ktorý je distribuovaný spolu s touto aplikáciou.",
    "Unable to login into Roundcube, there are login errors. Please check\nyour personal Roundcube settings. Maybe a re-login to Nextcloud\nhelps. Otherwise contact your system administrator." : "Nie je možné sa prihlásiť do Roundcube, vyskytli sa chyby pri prihlasovaní. Skontrolujte svoje osobné nastavenia Roundcube. Možno pomôže opätovné prihlásenie do Nextcloud. Inak kontaktujte svojho správcu systému.",
    ...
    "The email user id is not configured. Please check your personal Roundcube settings." : "ID e-mailového používateľa nie je nastavené. Skontrolujte si svoje osobné nastavenia v Roundcube.",
