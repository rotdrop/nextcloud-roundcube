OC.L10N.register(
    ...
    "RCMCardDAV Plugin Configuration" : "RCMCardDAV eklentisi yapılandırması",
    "ClipBoard" : "Pano",
    "Below is a configuration snippet which may or may not work with the current version of the RoundCube CardDAV plugin. The configuration shown below is just a suggestion and will not automatically be registered with the RoundCube app. It is your responsibility to configure the RoundCube CardDAV plugin correctly. Please have a look at the explanations in the README.md file." : "Aşağıda RoundCube CardDAV eklentisinin güncel sürümüyle çalışabilecek veya çalışmayabilecek bir yapılandırma bölümü bulunuyor. Aşağıda gösterilen yapılandırma yalnızca bir öneridir ve RoundCube uygulamasına otomatik olarak kaydedilmeyecektir. RoundCube CardDAV uygulama ekini doğru şekilde yapılandırmak sizin sorumluluğunuzdadır. Lütfen README.md dosyasındaki açıklamalara bakın.",
