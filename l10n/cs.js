OC.L10N.register(
    ...
    "Unable to login into Roundcube, there are login errors. Please check your personal Roundcube settings. Maybe a re-login to Nextcloud helps. Otherwise contact your system administrator." : "Nelze se přihlásit do Roundcube, dochází k chybám přihlášení. Zkontrolujte prosím své osobní nastavení Roundcube. Možná pomůže opětovné přihlášení do služby Nextcloud. V opačném případě se obraťte na správce systému.",
    ...
    "Email user for Roundcube" : "E-mailový uživatel pro Roundcube",
    "Email password for Roundcube" : "E-mailové heslo pro Roundcube",
    ...
    "Globally configured as {fixedSingleEmailAddressAdmin}" : "Globálně nakonfigurováno jako {fixedSingleEmailAddressAdmin}",
    "Please specify an email address to use with RoundCube." : "Zadejte e-mailovou adresu kterou použít s RoundCube.",
    "Globally configured by the administrator" : "Globálně nakonfigurováno správcem",
