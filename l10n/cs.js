OC.L10N.register(
    ...
    "Config template has been copied to the clipboard." : "Šablona nastavení byla zkopírována do schránky.",
    "Failed copying the config template to the clipboard: {reason}." : "Nepodařilo se zkopírovat šablonu nastavení do schránky: {reason}.",
    ...
    "RoundCube path can be entered relative to the Nextcloud server" : "Cestu k RoundCube lze zadat relativně k serveru Nextcloud.",
    ...
    "Fixed Single Address" : "Pevná jednotná adresa",
    "Global Email Login" : "Globální e-mailové přihlášení",
    "Global email user-name for Roundcube for all users" : "Globální e-mailové uživatelské jméno pro Roundcube pro všechny uživatele",
    "Email Address" : "E-mailová adresa",
    "Global email password for Roundcube for all users" : "Globální e-mailové heslo pro Roundcube pro všechny uživatele",
    "Global Email Password" : "Globální e-mailové heslo",
    "Email Password" : "E-mailové heslo",
    ...
    "RoundCube CardDAV Tag" : "RoundCube CardDAV štítek",
    "Tag of a preconfigured CardDAV account pointing to the cloud addressbook. See the documentation of the RCMCardDAV plugin." : "Štítek přednastaveného CardDAV účtu ukazujícího na adresář kontaktů v cloudu. Podrobnosti viz dokumentace k zásuvnému modulu RCMCardDAV.",
    "RCMCardDAV Plugin Configuration" : "Nastavení zásuvného modulu RCMCardDAV",
    "ClipBoard" : "Scrhánka",
    "Below is a configuration snippet which may or may not work with the current version of the RoundCube CardDAV plugin. The configuration shown below is just a suggestion and will not automatically be registered with the RoundCube app. It is your responsibility to configure the RoundCube CardDAV plugin correctly. Please have a look at the explanations in the README.md file." : "Níže je výstřižek z nastavení který může a nemusí fungovat ve stávající verzi zásuvného modulu RoundCube CardDAV. Níže zobrazené nastavení je pouze návrh a nebude automaticky zaregistrováno v aplikaci RoundCube. Je vaší odpovědností nastavit zásuvný modlu RoundCube CardDAV správně. Podívejte se na vysvětlení v souboru README.md.",
    "You did not tell me where to find your configured Roundcube\ninstance. Please head over to the admin-settings and configure this\napp, thank you! It might also be a good idea to have a look at the\nREADME.md file which is distributed together with this app." : "Neuvedli jste kde chcete hledat vámi využívanou nastavenou instanci Roundcube. Přejděte do nastavení pro správu a tuto aplikaci nastavte. Také může pomoci se podívat do souboru README.md, šířeného s touto aplikací.",
    "Unable to login into Roundcube, there are login errors. Please check\nyour personal Roundcube settings. Maybe a re-login to Nextcloud\nhelps. Otherwise contact your system administrator." : "Nedaří se přihlásit do Roundcube – dochází k chybám přihlášení. Zkontrolujte svá osobní nastavení v Roundcube. Možná pomůže opětovné přihlášení do Nextcloud. Pokud ne, obraťte se na správce.",
    "Unable to configure the CardDAV integration for \"{emailUserId}\"." : "Nepodařilo se nastavit CardDAV napojení pro „{emailUserId}“.",
    ...
    "RoundCube Wrapper for Nextcloud" : "Obalovací vrstva kolem RoundCube pro Nextcloud",
    "Globally configured as NEXTCLOUD_USER_ID@{emailDefaultDomainAdmin}" : "Globálně nastaveno jako NEXTCLOUD_IDENTIFIKATOR_UZIVATELE@{emailDefaultDomainAdmin}",
    "Globally configured as NEXTCLOUD_USER_ID" : "Globálně nastaveno jako NEXTCLOUD_IDENTIFIKATOR_UZIVATELE",
    ...
    "Globally configured as {fixedSingleEmailAddressAdmin}" : "Globálně nastaveno jako {fixedSingleEmailAddressAdmin}",
    "Please specify an email address to use with RoundCube." : "Zadejte e-mailovou adresu kterou použít s RoundCube.",
    "Globally configured by the administrator" : "Globálně nastaveno správcem",
    "Single sign-on is globally forced \"on\"." : "Jednotné přihlašování je globálně vynuceno jako „zapnuté“.",
