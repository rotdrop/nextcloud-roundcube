OC.L10N.register(
    ...
    "You did not tell me where to find your configured Roundcube\ninstance. Please head over to the admin-settings and configure this\napp, thank you! It might also be a good idea to have a look at the\nREADME.md file which is distributed together with this app." : "Sie haben mir nicht gesagt, wo ich Ihre konfigurierte Roundcube\nInstanz finde. Bitte gehen Sie zu den Administratoreinstellungen und konfigurieren Sie diese\nApp, vielen Dank! Es empfiehlt sich auch, einen Blick auf die Datei\nREADME.md zu werfen, die mit dieser App mitgeliefert wird.",
    "Unable to login into Roundcube, there are login errors. Please check\nyour personal Roundcube settings. Maybe a re-login to Nextcloud\nhelps. Otherwise contact your system administrator." : "Die Anmeldung bei Roundcube ist nicht möglich. Es liegen Anmeldefehler vor. Bitte überprüfen\nSie Ihre persönlichen Roundcube-Einstellungen. Möglicherweise hilft eine erneute Anmeldung bei Nextcloud.\nAndernfalls wenden Sie sich an Ihren Systemadministrator.",
