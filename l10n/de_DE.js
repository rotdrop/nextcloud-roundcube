OC.L10N.register(
    ...
    "You did not tell me where to find your configured Roundcube instance. Please head over to the admin-settings and configure this app, thank you! It might also be a good idea to have a look at the README.md file which is distributed together with this app." : "Sie haben nicht angegeben, wo sich Ihre konfigurierte Roundcube-Instanz befindet. Bitte konfigurieren Sie diese App den Admin-Einstellungen. Vielen Dank! Bitte sehen Sie auch in die mit dieser App ausgelieferte README.md-Datei.",
    "Unable to login into Roundcube, there are login errors. Please check your personal Roundcube settings. Maybe a re-login to Nextcloud helps. Otherwise contact your system administrator." : "Sie können sich nicht in Roundcube einloggen, es liegen Anmeldefehler vor. Bitte überprüfen Sie Ihre persönlichen Roundcube-Einstellungen. Eventuell hilft eine Neuanmeldung bei Nextcloud. Ansonsten kontaktieren Sie Ihre Systemadministration.",
    "Embedded RoundCube, Personal Settings" : "Eingebettetes RoundCube, Persönliche Einstellungen",
    "Email Login Name" : "Email Anmeldename",
    "Globally configured as USERID@{emailDefaultDomainAdmin}" : "Global konfiguriert als USERID@{emailDefaultDomainAdmin}",
