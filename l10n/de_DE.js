OC.L10N.register(
    ...
    "Disable when debugging with self-signed certificates." : "Deaktivieren Sie diese Option beim Debuggen mit selbstsignierten Zertifikaten.",
    "Enable SSL verification." : "SSL-Überprüfung aktivieren.",
    "Encrypt per-user data -- in particular their email passwords -- with their personal cloud password. This implies that these settings will be lost when users forget their passwords. If unchecked the email login credentials are still protected by the server secret. The latter implies that an administrator is able to decrypt the login credentials, but the configuration data survives user password-loss." : "Verschlüsseln Sie die Daten der einzelnen Benutzer - insbesondere deren E-Mail-Passwörter - mit ihrem persönlichen Cloud-Passwort. Dies bedeutet, dass diese Einstellungen verloren gehen, wenn die Benutzer ihre Passwörter vergessen. Ist diese Option nicht aktiviert, sind die E-Mail-Anmeldedaten weiterhin durch das Servergeheimnis geschützt. Letzteres bedeutet, dass die Administration in der Lage ist, die Anmeldedaten zu entschlüsseln, aber die Konfigurationsdaten bleiben erhalten, wenn der Benutzer sein Passwort vergisst.",
    ...
    "Tag of a preconfigured CardDAV account pointing to the cloud addressbook. See the documentation of the RCMCardDAV plugin." : "Schlagwort eines vorkonfigurierten CardDAV-Kontos, das auf das Cloud-Adressbuch verweist. Siehe die Dokumentation des RCMCardDAV-Plugins.",
    "RCMCardDAV Plugin Configuration" : "RCMCardDAV-Plugin Einstellungen",
    "ClipBoard" : "Zwischenablage",
    "Below is a configuration snippet which may or may not work with the current version of the RoundCube CardDAV plugin. The configuration shown below is just a suggestion and will not automatically be registered with the RoundCube app. It is your responsibility to configure the RoundCube CardDAV plugin correctly. Please have a look at the explanations in the README.md file." : "Unten sehen Sie einen Konfigurationsausschnitt, der möglicherweise mit der aktuellen Version des RoundCube CardDAV-Plugins funktioniert. Die unten stehende Konfiguration ist nur ein Vorschlag und wird nicht automatisch in der RoundCube-App registriert. Es liegt an Ihnen, das RoundCube CardDAV-Plugin korrekt zu konfigurieren. Bitte beachten Sie die Erläuterungen in der Datei README.md.",
    "You did not tell me where to find your configured Roundcube\ninstance. Please head over to the admin-settings and configure this\napp, thank you! It might also be a good idea to have a look at the\nREADME.md file which is distributed together with this app." : "Sie haben nicht angegeben, wo Ihre konfigurierte Roundcube\nInstanz zu finden ist. Bitte gehen Sie zu den Administrationseinstellungen und konfigurieren Sie diese\nApp, vielen Dank! Es empfiehlt sich auch, einen Blick auf die Datei\nREADME.md zu werfen, die mit dieser App mitgeliefert wird.",
    "Unable to login into Roundcube, there are login errors. Please check\nyour personal Roundcube settings. Maybe a re-login to Nextcloud\nhelps. Otherwise contact your system administrator." : "Die Anmeldung bei Roundcube ist nicht möglich. Es liegen Anmeldefehler vor. Bitte die\npersönlichen Roundcube-Einstellungen überprüfen. Möglicherweise hilft eine erneute Anmeldung bei Nextcloud.\nAndernfalls wenden Sie sich an Ihre Systemadministration.",
    "Unable to configure the CardDAV integration for \"{emailUserId}\"." : "Die CardDAV-Integration für \"{emailUserId}\" kann nicht konfiguriert werden.",
    "Unable to obtain email credentials for \"{emailUserId}\". Please check your personal Roundcube settings." : "E-Mail-Anmeldeinformationen für \"{emailUserId}\" konnten nicht abgerufen werden. Bitte überprüfen Sie Ihre persönlichen Roundcube-Einstellungen.",
    "The email user id is not configured. Please check your personal Roundcube settings." : "Die E-Mail-Benutzer-ID ist nicht eingerichtet. Bitte Ihre persönlichen Roundcube-Einstellungen überprüfen.",
    ...
    "Please specify an email address to use with RoundCube." : "Bitte geben Sie eine E-Mail-Adresse an, die Sie mit RoundCube verwenden möchten.",
