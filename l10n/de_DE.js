OC.L10N.register(
    ...
    "restore palette" : "Farbskala wiederherstellen",
    "factory reset palette" : "Werksreset der Farbskala",
    ...
    "Tag of a preconfigured CardDAV account pointing to the cloud addressbook. See the documentation of the RCMCardDAV plugin." : "Schlagwort eines vokonfigurierten CardDAV-Kontos, das auf das Cloud-Adressbuch verweist. Siehe die Dokumentation des RCMCardDAV-Plugins.",
    ...
    "Below is a configuration snippet which may or may not work with the current version of the RoundCube CardDAV plugin. The configuration shown below is just a suggestion and will not automatically be registered with the RoundCube app. It is your responsibility to configure the RoundCube CardDAV plugin correctly. Please have a look at the explanations in the README.md file." : "Unten sehen Sie einen Konfigurationsausschnitt, der möglicherweise mit der aktuellen Version des RoundCube CardDAV-Plugins funktioniert oder auch nicht. Die unten stehende Konfiguration ist nur ein Vorschlag und wird nicht automatisch in der RoundCube-App registriert. Es liegt an Ihnen , das RoundCube CardDAV-Plugin korrekt zu konfigurieren. Bitte beachten Sie die Erläuterungen in der Datei README.md.",
